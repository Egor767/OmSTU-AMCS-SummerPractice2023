...
namespace XUnit.Coverlet.MSBuild
{
    ...
    public partial class УравнениеFeature : object, Xunit.IClassFixture<УравнениеFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public УравнениеFeature(УравнениеFeature.FixtureData fixtureData, XUnit_Coverlet_MSBuild_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "", "уравнение", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "уравнение")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                УравнениеFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                УравнениеFeature.FeatureTearDown();
            }
        }
    }
}
